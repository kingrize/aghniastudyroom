...
// SPLIT COLUMNS (MANUAL MASONRY)
const leftCol = computed(() =>
    filteredQuestions.value.filter((_, i) => i % 2 === 0),
);
    ...
    >
        ...
        <main class="max-w-6xl mx-auto px-6 md:px-12 relative z-10 pt-4">
            ...
            <div v-else-if="filteredQuestions.length > 0">
                <div class="md:hidden flex flex-col gap-4 pb-12">
                    <QuestionCard
                ...
                <div class="hidden md:grid grid-cols-2 gap-6 items-start pb-12">
